...
final _schema =
    '[{"name":"TaskModelDb","idProperty":"id","properties":[{"name":"id","type":3},{"name":"content","type":5},{"name":"endTime","type":3},{"name":"isComplete","type":0}],"indexes":[],"links":[]}]';
  ...
  return openIsarInternal(
      ...
      getCollections: (isar) {
        ...
        collections['TaskModelDb'] = IsarCollectionImpl<TaskModelDb>(
          ...
          propertyIds: {'id': 0, 'content': 1, 'endTime': 2, 'isComplete': 3},
          indexIds: {},
          linkIds: {},
          backlinkIds: {},
          getId: (obj) => obj.id,
...
extension TaskModelDbQueryFilter
  ...
  QueryBuilder<TaskModelDb, QAfterFilterCondition> endTimeIsNull() {
    return addFilterCondition(FilterCondition(
      type: ConditionType.Eq,
      property: 'endTime',
      value: null,
  ...
  QueryBuilder<TaskModelDb, QAfterFilterCondition> endTimeEqualTo(
      DateTime? value) {
    return addFilterCondition(FilterCondition(
      type: ConditionType.Eq,
      property: 'endTime',
  ...
  QueryBuilder<TaskModelDb, QAfterFilterCondition> endTimeGreaterThan(
      DateTime? value) {
    return addFilterCondition(FilterCondition(
      type: ConditionType.Gt,
      property: 'endTime',
  ...
  QueryBuilder<TaskModelDb, QAfterFilterCondition> endTimeLessThan(
      DateTime? value) {
    return addFilterCondition(FilterCondition(
      type: ConditionType.Lt,
      property: 'endTime',
  ...
  QueryBuilder<TaskModelDb, QAfterFilterCondition> endTimeBetween(
...
extension TaskModelDbQueryWhereSortBy on QueryBuilder<TaskModelDb, QSortBy> {
  ...
  QueryBuilder<TaskModelDb, QAfterSortBy> sortByEndTime() {
    return addSortByInternal('endTime', Sort.Asc);
  }

  QueryBuilder<TaskModelDb, QAfterSortBy> sortByEndTimeDesc() {
...
extension TaskModelDbQueryWhereSortThenBy
  ...
  QueryBuilder<TaskModelDb, QAfterSortBy> thenByEndTime() {
    return addSortByInternal('endTime', Sort.Asc);
  }

  QueryBuilder<TaskModelDb, QAfterSortBy> thenByEndTimeDesc() {
    return addSortByInternal('endTime', Sort.Desc);
  }
...
extension TaskModelDbQueryWhereDistinct
  ...
  QueryBuilder<TaskModelDb, QDistinct> distinctByEndTime() {
...
extension TaskModelDbQueryProperty
  ...
  QueryBuilder<DateTime?, QQueryOperations> endTimeProperty() {
    return addPropertyName('endTime');
  }
